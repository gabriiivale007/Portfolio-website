  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-16">
        <div
          className={`bg-black rounded-3xl overflow-hidden transition-all duration-1000 ${
              ...
              <div className="space-y-2">
                {processSteps.map((step, index) => (
                  <button
                    ...
                    className={`block font-display text-5xl sm:text-6xl lg:text-7xl xl:text-8xl tracking-tight transition-all duration-500 ${
